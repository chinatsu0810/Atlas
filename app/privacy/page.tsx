      ...
      <div className="mx-auto max-w-3xl space-y-8 px-4 py-10">
        ...
        <Section number={1} title="取得する情報">
          ...
          <BulletList>
            ...
            <li>
              <span className="font-medium">「譲る」の情報</span>
              ：投稿（写真、説明、カテゴリ、国・都市・受け渡しエリア、価格、受け渡し可能期限）、コメントとメッセージ、取引の状態、通報の内容。
              写真に含まれる撮影場所などの位置情報（Exif）は、アップロードする前に、お使いの端末の上で削除します。
            </li>
            <li>
        ...
        <Section number={2} title="利用目的">
          ...
          <BulletList>
            ...
            <li>パスワードの再設定や、「譲る」の新着コメント・メッセージのお知らせなど、当サービスの利用に必要なご連絡</li>
        ...
        <Section number={3} title="投稿の公開について">
          ...
          <p>
            「譲る」の投稿（写真を含む）も、ニックネームとともに誰でも閲覧でき、検索エンジンに表示されることがあります。
            一方、希望者のコメントと取引ページのメッセージは、投稿者とその希望者の2人だけが閲覧できます。
            ただし、通報があった場合や、利用規約に違反するおそれがある場合には、その調査に必要な範囲で、運営者が内容を確認することがあります。
          </p>
        </Section>
        ...
        <Section number={4} title="外部サービスの利用">
          ...
          <BulletList>
            ...
            <li>
              ...
              （ファイルの保存）：「譲る」に投稿された写真。写真は公開され、URLを知っていれば誰でも閲覧できます。
            </li>
            <li>
              <span className="font-medium">Resend</span>
              （メールの配信）：お問い合わせを運営者に通知するメールと、パスワード再設定のメールの、宛先のメールアドレスと本文。
              お問い合わせの通知メールには、お名前、メールアドレス、お問い合わせの内容が含まれます。
              「譲る」のお知らせメール（新着コメント・メッセージ、取引の状態の変化）には、宛先のメールアドレスと投稿のタイトルが含まれます。コメントやメッセージの内容は含みません。
              「譲る」の通報を運営者に通知するメールには、通報の内容が含まれます。
            </li>
            <li>
        ...
        <Section number={7} title="アカウントの削除と、情報の保存期間">
          ...
          <BulletList>
            ...
            <li>
              「譲る」の投稿は、削除と同時に非表示にし、進行中の取引は終了します。30日後に、写真、コメント・メッセージ、あなたが希望者として送ったコメント・メッセージ、あなたの通報とあわせて、完全に削除します。
            </li>
            <li>
          ...
          <BulletList>
            <li>
              「譲る」のコメント・メッセージ：取引の完了、投稿の取り下げ、または募集期間の終了から1年後に削除します。
            </li>
            <li>
